...
@Component({
  ...
  template: `
    <div class="mx-auto max-w-5xl py-12 text-center">
      ...
      <h1 class="mb-3 text-[28px] font-[590] tracking-tight text-[var(--color-porcelain)]">Subastas</h1>
      <p class="text-[15px] text-[var(--color-storm-cloud)]">Explorá las subastas activas y participá en tiempo real.</p>
